...
export const ChatApp = () => {
    ...
    const connectWebSocket = () => {
        ...
        const client = new Client({
            brokerURL: "wss://9e97b2d83d2d0de2cc31eb56f3939262.serveo.net/ws",
            onConnect: (frame) => {
                            ...
                            >
                                <Avatar>
                                    {user && user.pictures && user.pictures.length > 0 ? (
                                        <img
                                            src={`https://9e97b2d83d2d0de2cc31eb56f3939262.serveo.net/api/show/${user.id}/${user.pictures[0].pictureName}`}
                                            alt="Avatar"
                                        />
                                    ) : (
